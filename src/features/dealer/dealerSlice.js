...
const initialState = {
  ...
  filter: {
    ...
    searchProperty: {
        '0': { id: 'all', label: "All" },
        'dealer_name': { id: 8, key: 'dealer_name', label: 'Dealer Name', isNested: false, children: [] },
...
const dealer = createSlice({
  ...
  reducers: {
    ...
    updateFilterFieldDealer: (state, action) => {
        state.filter.searchField = action.payload
    },
    updateFilterValueDealer: (state, action) => {
        state.filter.searchValue = action.payload
    },
    updateFilterPropertyDealer: (state, action) => {
...
export const { updateFilter, updateValue, updateFilterFieldDealer, updateFilterValueDealer, updateFilterPropertyDealer} = dealer.actions;

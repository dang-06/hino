...
import { useGetFinishedJobsQuery } from "../services/apiSlice";
...
const JobsFinishedManagement = () => {
  ...
  const { data, isLoading, isFetching, refetch } =
    useGetFinishedJobsQuery(criterias);
    ...
    <>
      <div className=" flex">
              ...
              {enableCheckbox ? (
                <div className="flex items-center">
                  ...
                  <div className="title text-[16px]">
                    {Object.values(selectedCheckbox).filter((i) => i).length}{" "}
                    Selected
                  </div>
                </div>
              ) : (
        ...
        >
          ...
          <div className="overflow-autos h-[calc(100vh_-_110px)] lg:mx-auto lg:max-w-full">
            <div
...
export default JobsFinishedManagement;

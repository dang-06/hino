...
export const BootstrapInput = styled(InputBase)(({ theme }) => ({
    ...
    '& .MuiInputBase-input': {
      ...
      position: 'relative',
      border: '1px solid',
      borderColor: theme.palette.mode === 'light' ? '#464f617d' : '#2D3843',
      width: '100%',
      padding: '5px 9px',
      color: '#464F60',
...
const CustomTextField = ({ name, label, control, errors, required, readOnly = false, infor, inforText ='', type="text", placeholder, ...rest }) => {
        ...
        <Controller
            ...
            render={({ field }) => (
                ...
                >
                    ...
                    />
                    <small className="text-danger-500 mt-1">{errors?.message}</small>
                </FormControl>
            )}
        />
    );

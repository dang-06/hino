...
const CustomAsyncSelect2 = ({label, data, isLoading, isFetching, onChange, readOnly, placeholder, infor, inforText, setSearch, errors, required, multiple=true, className="w-[300px]", defaultValue, clearValue, ...rest }) => {
...
export default CustomAsyncSelect2;

...
const CustomDateField2 = ({ name, label, format = "DD/MM/YYYY", control, errors, minDate, required, infor, inforText, ...rest }) => {
      ...
      render={({ field: { value, onChange } }) => (
        <DatePicker
          ...
          renderInput={(params) => (
            ...
            {label && <label className="font-regular text-secondary flex items-center gap-1 mb-1">
                {t(label)}

...
const CustomNumberField = ({ name, label, control, errors, required, infor, inforText ='', type="text", placeholder, ...rest }) => {
          ...
          customInput={(params) => {
            ...
            <div className="flex flex-col w-full justify-between">
                ...
                <div className="mt-[5px]">
                    ...
                    <BootstrapInput {...params}/>
                    <small className="text-danger-500 mt-1 block">{errors?.message}</small>

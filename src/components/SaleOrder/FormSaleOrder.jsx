...
const FormSaleOrder = ({ selectedItem, triggleSubmit, setTriggleSubmit, submitError, refetch, setOpenForm }) => {
    ...
    const [updateForm, { isLoading: isLoading1 }] = useUpdateSaleOrderMutation();
    const [addForm, { isLoading: isLoading2 }] = useAddSaleOrderMutation();
                        ...
                        <div className="flex">
                            ...
                            <div className="flex flex-col ml-3 items-start">
                                <h2 className="text-lg font-medium capitalize ">
                                    {t("addTitle", { field: t("SaleOrder") })}
                                </h2>
                                <div className="mt-1">
                                    <p className="text-sm text-light">
                                        {t("addSubtitle", { field: t("SaleOrder") })}
                                    </p>
                                </div>
                            </div>
                        </div>
